...
import com.mycompany.proxectoorganizandotabbedpane.controller.Controller;
    ...
    public MainFrame() {
        ...
        tablePanel.setPersonTableListener(new PersonTableListener() {
            public void rowDeleted(int row) {
                String people = controller.removePerson(row);
                textPanel.setText(people);
        ...
        formPanel.setFormListener(new FormListener(){
            ...
            public void textEmitted(FormEvent e) {
                String people =controller.addPerson(e); //IMPORTANTE
            ...
            public void optionEmitted(boolean option) {
                if(option){
                    ...
                    if (returnVal == JFileChooser.APPROVE_OPTION) {
                        ...
                        try {
                            String people =controller.loadFromFile(fc.getSelectedFile());
                            tablePanel.refresh();
                            textPanel.setText(people);
        ...
        textPanel.setText(controller.getPeopleString());
        tabbedPane= new JTabbedPane();
        tabbedPane.addTab("Tabla", tablePanel);
        tabbedPane.addTab("Texto", textPanel);

        splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, formPanel, tabbedPane); //IMPORTANTE
