 ...
 */
package com.mycompany.proxectoorganizandoserializacion.gui;
...
public class FormPanel extends JPanel{
    ...
    public FormPanel(){
        ...
        listaAge.setSelectedIndex(0);//IMPORTANTE (ten que estar despois de meterlle o modelo)
        ...
        employmentBox.setPreferredSize(new Dimension(105,30));
        ...
        ActionListener al = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int idade =  listaAge.getSelectedIndex(); //IMPORTANTE
                String employmentText= employmentBox.getSelectedItem().toString();
                String genderText = genderGrp.getSelection().getActionCommand();
                String taxText= taxTxt.getText();
                if(!citizenChk.isSelected()){
                    taxText="";
                }
                if (formListener != null) {
                        FormEvent se = new FormEvent(this, nameTxt.getText(), occupationTxt.getText(), idade, employmentText, taxText,citizenChk.isSelected(),genderText);
